...
// Copyright (c) 2014 The CornerstoneCoin developers
...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 25;	// stake age of full weight: 25d
unsigned int nStakeTargetSpacing = 45;			// 45 sec block spacing

int64 nChainStartTime = 1398657333;
...
static const int64 nMinSubsidy = 15 * COIN;
static const int CUTOFF_HEIGHT = 34560;	// Height at the end of 18 days
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	else if(nHeight > CUTOFF_HEIGHT)	// will be blocked all the pow after CUTOFF_HEIGHT (not really with the 15 coin reward...just highly discouraged)
	{
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in CornerstoneCoin
    bool fStrictPayToScriptHash = true; // Always active in CornerstoneCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CornerstoneCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
               // const char* pszTimestamp = "AP | Mar 2, 2014, 10.35 AM IST: China blames Uighur separatists for knife attack; 33 dead";
                const char* pszTimestamp = "CCX - 24th April 2014";
                CTransaction txNew;
                ...
                assert(block.hashMerkleRoot == uint256("7e98064f024bbfebf4712658a369ff87e4fb3251ee3d91692fcabdc6e3701f33"));
